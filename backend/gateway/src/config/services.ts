...
// IntrospectAndCompose requires every entry here to respond at startup, so
// only services that actually exist can be listed. Restore the commented
// ones as each is built.
